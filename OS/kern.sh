...
i686-elf-gcc -c init_idt.c -o init.o -std=gnu99 -ffreestanding -O2 -Wall -mgeneral-regs-only
...
i686-elf-gcc -T kern.ld -o os.bin -ffreestanding -O2 -nostdlib boot.o kernel.o keyboard.o init.o ./basic/*.o  -lgcc
rm ./iso/boot/os.bin
cp os.bin ./iso/boot/
